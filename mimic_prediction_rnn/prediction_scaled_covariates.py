    ...
    for parameter in parameters:
        ...
        for window_idx in range(n_windows):
            ...
            train_series_endo_high_f = open(f'./data/darts/{n_chunks}_chunks/{style}/{model_type}/{parameter}/{endogenous_input}/'
                                            f'01_train_series_endo_high_scaled_window{window_idx}.pickle', 'wb')
            ...
            train_series_endo_low_f = open(f'./data/darts/{n_chunks}_chunks/{style}/{model_type}/{parameter}/{endogenous_input}/'
                                           f'01_train_series_endo_low_scaled_window{window_idx}.pickle', 'wb')
            ...
            train_series_exo_f = open(f'./data/darts/{n_chunks}_chunks/{style}/{model_type}/{parameter}/{endogenous_input}/'
                                      f'01_train_series_exo_scaled_window{window_idx}.pickle', 'wb')
            ...
            pred_series_endo_high_f = open(f'./data/darts/{n_chunks}_chunks/{style}/{model_type}/{parameter}/{endogenous_input}/'
                                           f'02_pred_series_endo_high_scaled_window{window_idx}.pickle', 'wb')
            ...
            pred_series_endo_low_f = open(f'./data/darts/{n_chunks}_chunks/{style}/{model_type}/{parameter}/{endogenous_input}/'
                                          f'02_pred_series_endo_low_scaled_window{window_idx}.pickle', 'wb')
            ...
            pred_series_exo_f = open(f'./data/darts/{n_chunks}_chunks/{style}/{model_type}/{parameter}/{endogenous_input}/'
                                     f'02_pred_series_exo_scaled_window{window_idx}.pickle', 'wb')
            ...
            pred_scaler_f = open(f'./data/darts/{n_chunks}_chunks/{style}/{model_type}/{parameter}/{endogenous_input}/'
                                 f'03_pred_scaler_window{window_idx}.pickle', 'wb')
            ...
            param_model_high_f = open(f'./data/darts/{n_chunks}_chunks/{style}/{model_type}/{parameter}/{endogenous_input}/'
                                      f'04_pre-trained_model_high_scaled_window{window_idx}.pickle', 'wb')
            ...
            param_model_low_f = open(f'./data/darts/{n_chunks}_chunks/{style}/{model_type}/{parameter}/{endogenous_input}/'
                                      f'04_pre-trained_model_low_scaled_window{window_idx}.pickle', 'wb')
            ...
            for chunk_id in pred_series_endo_high.keys():
                ...
                model_original_f = open(f'./data/darts/{n_chunks}_chunks/{style}/{model_type}/{parameter}/{endogenous_input}/'
                                        f'04_pre-trained_model_high_scaled_window{window_idx}.pickle', 'rb')
                ...
                final_pred_high_f = open(f'./data/darts/{n_chunks}_chunks/{style}/{model_type}/{parameter}/{endogenous_input}/'
                                         f'05_prediction_{chunk_id}_high_scaled_window{window_idx}.pickle', 'wb')
                ...
                # Load original pre-trained model
                model_original_f = open(f'./data/darts/{n_chunks}_chunks/{style}/{model_type}/{parameter}/{endogenous_input}/'
                                        f'04_pre-trained_model_low_scaled_window{window_idx}.pickle', 'rb')
                ...
                final_pred_low_f = open(f'./data/darts/{n_chunks}_chunks/{style}/{model_type}/{parameter}/{endogenous_input}/'
                                        f'05_prediction_{chunk_id}_low_scaled_window{window_idx}.pickle', 'wb')
...
confusion_matrix_models_f = open(f'./data/darts/{n_chunks}_chunks/{style}/confusion_matrix_models_scaled_{endogenous_input}'
                                 f'.pickle', 'wb')
