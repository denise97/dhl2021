"""
    PREDICTION WITH ALL RNN MODELS, ALL PARAMETERS, AND MAX/ MIN RESAMPLED CHUNKS
    ...
    for parameter in parameters:
        ...
        for window_idx in range(n_windows):
            ...
            train_series_endo_high_f = open(f'./data/{approach}/{n_chunks}_chunks/{style}/{model_type}/{parameter}/'
                                            f'{endogenous_input}/01_train_series_endo_high_normal_window{window_idx}'
                                            f'.pickle', 'wb')
            ...
            train_series_endo_low_f = open(f'./data/{approach}/{n_chunks}_chunks/{style}/{model_type}/{parameter}/'
                                           f'{endogenous_input}/01_train_series_endo_low_normal_window{window_idx}'
                                           f'.pickle', 'wb')
            ...
            train_series_exo_f = open(f'./data/{approach}/{n_chunks}_chunks/{style}/{model_type}/{parameter}/'
                                      f'{endogenous_input}/01_train_series_exo_normal_window{window_idx}.pickle', 'wb')
            ...
            pred_series_endo_high_f = open(f'./data/{approach}/{n_chunks}_chunks/{style}/{model_type}/{parameter}/'
                                           f'{endogenous_input}/02_pred_series_endo_high_normal_window{window_idx}'
                                           f'.pickle', 'wb')
            ...
            pred_series_endo_low_f = open(f'./data/{approach}/{n_chunks}_chunks/{style}/{model_type}/{parameter}/'
                                          f'{endogenous_input}/02_pred_series_endo_low_normal_window{window_idx}'
                                          f'.pickle', 'wb')
            ...
            pred_series_exo_f = open(f'./data/{approach}/{n_chunks}_chunks/{style}/{model_type}/{parameter}/'
                                     f'{endogenous_input}/02_pred_series_exo_normal_window{window_idx}.pickle', 'wb')
            ...
            param_model_high_f = open(f'./data/{approach}/{n_chunks}_chunks/{style}/{model_type}/{parameter}/'
                                      f'{endogenous_input}/04_pre-trained_model_high_normal_window{window_idx}.pickle',
                                      'wb')
            ...
            param_model_low_f = open(f'./data/{approach}/{n_chunks}_chunks/{style}/{model_type}/{parameter}/'
                                     f'{endogenous_input}/04_pre-trained_model_low_normal_window{window_idx}.pickle',
                                     'wb')
            ...
            for chunk_id in pred_series_endo_high.keys():
                ...
                model_original_high_f = open(f'./data/{approach}/{n_chunks}_chunks/{style}/{model_type}/{parameter}/'
                                             f'{endogenous_input}/04_pre-trained_model_high_normal_window{window_idx}'
                                             f'.pickle', 'rb')
                ...
                final_pred_high_f = open(f'./data/{approach}/{n_chunks}_chunks/{style}/{model_type}/{parameter}/'
                                         f'{endogenous_input}/05_prediction_{chunk_id}_high_normal_window{window_idx}'
                                         f'.pickle', 'wb')
                ...
                model_original_low_f = open(f'./data/{approach}/{n_chunks}_chunks/{style}/{model_type}/{parameter}/'
                                            f'{endogenous_input}/04_pre-trained_model_low_normal_window{window_idx}'
                                            f'.pickle', 'rb')
                ...
                final_pred_low_f = open(f'./data/{approach}/{n_chunks}_chunks/{style}/{model_type}/{parameter}/'
                                        f'{endogenous_input}/05_prediction_{chunk_id}_low_normal_window{window_idx}'
                                        f'.pickle', 'wb')
        ...
        confusion_matrix_models = confusion_matrix_models.append({
            ...
            # n = not scaled
            # H = High
            'ID': f'{parameter.upper()}_{model_type[:2]}_02_n_H',
            'PARAMETER': parameter.upper(),
            'RUNTIME': runtime,
            'MODEL': model_type,
            'SCALING': np.nan,
        ...
        confusion_matrix_models = confusion_matrix_models.append({
            ...
            # n = not scaled
            # L = Low
            'ID': f'{parameter.upper()}_{model_type[:2]}_02_n_L',
            'PARAMETER': parameter.upper(),
            'RUNTIME': runtime,
            'MODEL': model_type,
            'SCALING': np.nan,
