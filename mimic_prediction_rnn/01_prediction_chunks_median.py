...
for model_type in model_types:
    ...
    model = RNNModel(model=model_type,
                     ...
                     batch_size=input_length)  # batch_size must be <= input_length (bug in Darts)
    ...
    for parameter in parameters:
        ...
        # Create training and prediction series as {chunkID : TimeSeries} dict
        train_series = dict()
        ...
        confusion_matrix_models = confusion_matrix_models.append({
            'ID': f'{parameter.upper()}_R_01_B',  # R = RNNModel, 01 = MEDIAN, and B = Both
