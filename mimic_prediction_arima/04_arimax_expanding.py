...
for j, chunk in enumerate(dict_of_chunk_series_with_test_and_train_and_forecast):
    ...
    for i, chunk_iteration in enumerate(dict_of_chunk_series_with_test_and_train_and_forecast[chunk]):
        ...
        try:
            ...
            forecast_arimax_high = pd.Series(arimax_high.predict(TEST, X=current_test_list_exog_high), index=[*range(TRAIN,TRAIN+TEST,1)], name="forecast_list_arimax_high")
            ...
            forecast_arimax_low = pd.Series(arimax_low.predict(TEST, X=current_test_list_exog_low), index=[*range(TRAIN,TRAIN+TEST,1)], name="forecast_list_arimax_low")
            ...
            #chunk_iterations_with_runtime_warning.to_parquet(str(path_to_data)+'chunk_iterations_with_runtime_warning_for_arimax_expanding_12_hr.parquet', engine='pyarrow')
            #chunk_iterations_with_runtime_warning.to_parquet(str(path_to_data)+'chunk_iterations_with_runtime_warning_for_arimax_expanding_12_bp.parquet', engine='pyarrow')
            #chunk_iterations_with_runtime_warning.to_parquet(str(path_to_data)+'chunk_iterations_with_runtime_warning_for_arimax_expanding_12_o2.parquet', engine='pyarrow')
            chunk_iterations_with_runtime_warning.to_parquet(str(path_to_data)+'chunk_iterations_with_runtime_warning_for_arimax_expanding_12_hr_first1000.parquet', engine='pyarrow')
            #chunk_iterations_with_runtime_warning.to_parquet(str(path_to_data)+'chunk_iterations_with_runtime_warning_for_arimax_expanding_12_bp_first1000.parquet', engine='pyarrow')
            #chunk_iterations_with_runtime_warning.to_parquet(str(path_to_data)+'chunk_iterations_with_runtime_warning_for_arimax_expanding_12_o2_first1000.parquet', engine='pyarrow')
...
# output_file = open(str(path_to_data)+'accuracy_dict_for_chunk_iterations_arimax_expanding_12_hr.pickle', 'wb')
# output_file = open(str(path_to_data)+'accuracy_dict_for_chunk_iterations_arimax_expanding_12_bp.pickle', 'wb')
# output_file = open(str(path_to_data)+'accuracy_dict_for_chunk_iterations_arimax_expanding_12_o2.pickle', 'wb')
output_file = open(str(path_to_data)+'accuracy_dict_for_chunk_iterations_arimax_expanding_12_hr_first1000.pickle', 'wb')
# output_file = open(str(path_to_data)+'accuracy_dict_for_chunk_iterations_arimax_expanding_12_bp_first1000.pickle', 'wb')
# output_file = open(str(path_to_data)+'accuracy_dict_for_chunk_iterations_arimax_expanding_12_o2_first1000.pickle', 'wb')
