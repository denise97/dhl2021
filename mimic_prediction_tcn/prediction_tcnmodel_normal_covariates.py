"""
    PREDICTION WITH TCN MODEL, ALL PARAMETERS, AND MAX AND MIN RESAMPLED CHUNKS
    ...
    adjust which input size is taken and what parameters and models are used for the prediction, have a look at the
    five variables from line 29 to 40.
...
for parameter in parameters:
    ...
    for window_idx in range(n_windows):
        ...
        train_series_endo_high_f = open(f'./data/{approach}/{n_chunks}_chunks/{style}/{parameter}/{endogenous_input}/'
        ...
        train_series_endo_low_f = open(f'./data/{approach}/{n_chunks}_chunks/{style}/{parameter}/{endogenous_input}/'
        ...
        train_series_exo_f = open(f'./data/{approach}/{n_chunks}_chunks/{style}/{parameter}/{endogenous_input}/'
        ...
        pred_series_endo_high_f = open(f'./data/{approach}/{n_chunks}_chunks/{style}/{parameter}/{endogenous_input}/'
        ...
        pred_series_endo_low_f = open(f'./data/{approach}/{n_chunks}_chunks/{style}/{parameter}/{endogenous_input}/'
        ...
        pred_series_exo_f = open(f'./data/{approach}/{n_chunks}_chunks/{style}/{parameter}/{endogenous_input}/'
        ...
        param_model_high_f = open(f'./data/{approach}/{n_chunks}_chunks/{style}/{parameter}/{endogenous_input}/'
        ...
        # Save pre-trained model as pickle file
        param_model_low_f = open(f'./data/{approach}/{n_chunks}_chunks/{style}/{parameter}/{endogenous_input}/'
        ...
        for chunk_id in pred_series_endo_high.keys():
            ...
            model_original_high_f = open(f'./data/{approach}/{n_chunks}_chunks/{style}/{parameter}/{endogenous_input}/'
            ...
            final_pred_high_f = open(f'./data/{approach}/{n_chunks}_chunks/{style}/{parameter}/{endogenous_input}/'
            ...
            model_original_low_f = open(f'./data/{approach}/{n_chunks}_chunks/{style}/{parameter}/{endogenous_input}/'
            ...
            # Save final prediction of chunk as pickle file
            final_pred_low_f = open(f'./data/{approach}/{n_chunks}_chunks/{style}/{parameter}/{endogenous_input}/'
    ...
    for file in os.listdir(f'./data/{approach}/{n_chunks}_chunks/{style}/'):
        if os.path.isfile(os.path.join(f'./data/{approach}/{n_chunks}_chunks/{style}/', file)) and \
                file.startswith(f'confusion_matrix_chunks_{parameter}_{endogenous_input}_normal'):
